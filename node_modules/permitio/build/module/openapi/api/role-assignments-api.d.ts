...
export declare const RoleAssignmentsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listRoleAssignments: (projId: string, envId: string, user?: string, role?: string, tenant?: string, resource?: string, resourceInstance?: string, detailed?: boolean, includeTotalCount?: boolean, page?: number, perPage?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const RoleAssignmentsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    listRoleAssignments(projId: string, envId: string, user?: string, role?: string, tenant?: string, resource?: string, resourceInstance?: string, detailed?: boolean, includeTotalCount?: boolean, page?: number, perPage?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RoleAssignmentRead> | Array<RoleAssignmentDetailedRead> | PaginatedResultRoleAssignmentRead | PaginatedResultRoleAssignmentDetailedRead>>;
    /**
     * Unassigns a user role within a tenant.  The tenant defines the scope of the assignment. In other words, the role is effective only within the tenant.  If the role is not actually assigned, will return 404.
     * @summary Unassign Role
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare const RoleAssignmentsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    listRoleAssignments(projId: string, envId: string, user?: string, role?: string, tenant?: string, resource?: string, resourceInstance?: string, detailed?: boolean, includeTotalCount?: boolean, page?: number, perPage?: number, options?: any): AxiosPromise<Array<RoleAssignmentRead> | Array<RoleAssignmentDetailedRead> | PaginatedResultRoleAssignmentRead | PaginatedResultRoleAssignmentDetailedRead>;
    /**
     * Unassigns a user role within a tenant.  The tenant defines the scope of the assignment. In other words, the role is effective only within the tenant.  If the role is not actually assigned, will return 404.
     * @summary Unassign Role
     * @param {string} projId Either the unique id of the project, or the URL-friendly key of the project (i.e: the \&quot;slug\&quot;).
...
export declare class RoleAssignmentsApi extends BaseAPI {
     ...
     * @memberof RoleAssignmentsApi
     */
    listRoleAssignments(requestParameters: RoleAssignmentsApiListRoleAssignmentsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RoleAssignmentRead[] | RoleAssignmentDetailedRead[] | PaginatedResultRoleAssignmentRead | PaginatedResultRoleAssignmentDetailedRead, any>>;
    /**
     * Unassigns a user role within a tenant.  The tenant defines the scope of the assignment. In other words, the role is effective only within the tenant.  If the role is not actually assigned, will return 404.
     * @summary Unassign Role
